...
<head>
	...
	<title>C030320143 - Seina | Dashboard</title>
	...
	<div class="wrapper">
		...
		<header class="main-header">			
			<a href="<?php echo base_url(); ?>" class="logo">
				...
				<span class="logo-lg"><b>LSP POLIBAN</b></span>
			</a>
		...
		<aside class="main-sidebar">
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					?>
					<li>
						<a href="<?php echo base_url().'dashboard/suratmasuk' ?>">
							<i class="fa fa-th"></i>
					...
					?>
					<li>
						<a href="<?php echo base_url().'dashboard/suratkeluar' ?>">
